...
for year in range(0, term_years + 1):
    ...
    rows.append({
        ...
        "Gross Rent": gross_income,
        "PM Fees": pm_cost,
        "Interest": annual_interest_paid,
        "Principal": annual_principal_paid,
        "Debt Service": debt_service,
        "Insurance": annual_insurance,
        "Water": annual_water,
        "Council": annual_council,
        "Misc": annual_misc,
        ...
        "After-Tax Cashflow": after_tax_cashflow,
        "Depreciation Shield": dep_tax_shield,
        "Loan Balance": max(balance, 0.0)
    })
...
base = (
    ...
    .encode(
        ...
        tooltip=[
            ...
            alt.Tooltip('PV Growth % from Year1:Q', title='Value ↑ from Yr1 (%)', format='.0f') # Updated format
        ]
    )
)
...
val_chart = (
    ...
    .encode(
        ...
        tooltip=[
            alt.Tooltip('Year:Q', title='Year'),
            alt.Tooltip('Property Value:Q', title='Property Value', format=',.0f'), # Updated format
            alt.Tooltip('PV Growth % from Year1:Q', title='Value ↑ from Yr1 (%)', format='.0f') # Updated format
        ]
    )
    .interactive()
...
atcf_chart = (
    ...
    .encode(
        ...
        tooltip=[
            alt.Tooltip('Year:Q', title='Year'),
            alt.Tooltip('After-Tax Cashflow:Q', title='After-Tax Cashflow', format=',.0f') # Updated format
        ]
    )
    .interactive()
)
